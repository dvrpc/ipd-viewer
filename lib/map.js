    ...
    function identify(e) {
        ...
        var stationinfo = "<div><h3><i aria-hidden='true' class='fa fa-bar-chart'>&nbsp;&nbsp;IPD Indicators&nbsp;&nbsp;</i><sup><i class='glyphicon glyphicon-info-sign' id='info-icon' onclick='legendraw()'></i></sup></div>"
                          +"<div class='ipd-chart-info'>The information below provides a snapshot of key socio-economic, demographic, and select service performance indicators. The entire set of indicators may be downloaded in the Resources section below.</div>"
                          +"<div> Census Tract: <b>"+(props.GEOID10)+"</b></div>"

        var existingOVinfo = "<div><b>IPD Scoring by Census Tract</b></div>"
          
        var existinginfo ="<div class='tooltip_info'>Youth<span class='tooltip_info_text'>Youth Gone Wild represent those that have lots of young kids in the house</span></div>:&nbsp;" +(props.TCI_Data)+" <i>TCI Score</i></div>"
