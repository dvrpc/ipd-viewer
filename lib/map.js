    ...
    function identify(e) {
      ...
      //  var content = "<div style='margin-left: 25px;'> Census Tract: <b>"+(props.GEOID10)+"</b></div>"
        ...
        var stationinfo = "<div> Census Tract: <b>"+(props.GEOID10)+"</b></div>"
        ...
        var existingOVinfo = "<div><i class='glyphicon glyphicon-info-sign' id='info-icon' onclick='legendraw()'></i><b>IPD Scoring by Census Tract</b></div>"
        ...
        var existinginfo ="<div><i class='glyphicon glyphicon-info-sign' id='info-icon' onclick='legendraw()'></i><b <b style='font-size: 14px;'>IPD Indicators</b></div>"
                     //    +"<div class='tooltip_info'>Youth<span class='tooltip_info_text'>Youth Gone Wild represent those that have lots of young kids in the house</span></div>"
                         +"<div class='tooltip_info'>Youth<span class='tooltip_info_text'>Youth Gone Wild represent those that have lots of young kids in the house</span></div>:&nbsp;" +(props.TCI_Data)+" <i>TCI Score</i></div>"
                         ...
                         +"<div><b>LEP:</b>&nbsp; "+ numeral(props.Int_Data).format('0,0')+" <i> residents and workers within a half-mile of the station</i></div>"
                         +"<div><b>Disabled:</b>&nbsp; "+(props.Car_Data)+"% <i>housing units with zero or one vehicle</i></div>"
                         +"<div><b>Low-Income:</b>&nbsp; "+(props.Com_Data)+"%<i> residents who commute to work by public transportation, bicycle, or walking</i></div>"
