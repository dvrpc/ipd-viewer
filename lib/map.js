         ...
         style: getIMDStyle,
          onEachFeature: function (feature, layer) {
            feature.id = L.stamp(layer);
             ...
             //   var mcd2 = ;
        if (feature.properties.MUN2 ==='' ){ var mcd2 = 'blank';}
        else { var mcd2 = feature.properties.MUN2;}

                layer.bindLabel( 'Census Tract : ' + feature.properties.NAME10  +'<br> MCD : '+ feature.properties.MUN1 + mcd2 , {className: "leaflet-label" });   
