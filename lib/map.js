  ...
  //     });
      ...
      function identify(e) {
        ...
        var locationinfo = "<div class='location-list'>"+(props.MUN1)+", "+(props.CNTY_NAME)+" County <br><p style='font-size:16px'>Census Tract :<a href='https://factfinder.census.gov/bkmk/table/1.0/en/ACS/16_5YR/DP05/1400000US" + (props.GEOID10) + "' target='_blank' class='location-list-link'> "+(props.NAME10)+"</p></div>"
