  ...
  //     });
      ...
      function identify(e) {
        ...
        var tractuniverse ="<div> Population: " + (props.NAME10) +" total people<br>"
                          ...
                          +"</div>"
  //[props.FornBorn_7,props.,props.,props.Disabled_7,props.LowInc_S_1];
       
        if (props.AgeYouth_7 == 4 ){ var callout_colorY = '<div class="ipd-stat-score" style="background-color:#253494;color:#fff"> well above average</div>';}
        else if (props.AgeYouth_7 == 3 ){ var callout_colorY = '<div class="ipd-stat-score" style="background-color:#2c7fb8;color:#fff"> above average</div>'  ;}
        else if (props.AgeYouth_7 == 2 ){ var callout_colorY = '<div class="ipd-stat-score" style="background-color:#41b6c4;color:#fff"> average</div>'  ;}
        else if (props.AgeYouth_7 == 1 ){ var callout_colorY = '<div class="ipd-stat-score" style="background-color:#a1dab4;color:#fff"> below average</div>'  ;}
        else { var callout_colorY = '<div class="ipd-stat-score" style="background-color:#ffffcc;color:#1a2a2a;"> well below average</div>';}

        if (props.AgeOlder_7 == 4 ){ var callout_colorOA = '<div class="ipd-stat-score" style="background-color:#253494;color:#fff"> well above average</div>'  ;}
        else if (props.AgeOlder_7 == 3 ){ var callout_colorOA = '<div class="ipd-stat-score" style="background-color:#2c7fb8;color:#fff"> above average</div>'  ;}
        else if (props.AgeOlder_7 == 2 ){ var callout_colorOA = '<div class="ipd-stat-score" style="background-color:#41b6c4;color:#fff"> average</div>'  ;}
        else if (props.AgeOlder_7 == 1 ){ var callout_colorOA = '<div class="ipd-stat-score" style="background-color:#a1dab4;color:#fff"> below average</div>'  ;}
        else { var callout_colorOA = '<div class="ipd-stat-score" style="background-color:#ffffcc;color:#1a2a2a;"> well below average</div>';}

        if (props.SexFem_S_1 == 4 ){ var callout_colorF = '<div class="ipd-stat-score" style="background-color:#253494;color:#fff"> well above average</div>'  ;}
        else if (props.SexFem_S_1 == 3 ){ var callout_colorF = '<div class="ipd-stat-score" style="background-color:#2c7fb8;color:#fff"> above average</div>'  ;}
        else if (props.SexFem_S_1 == 2 ){ var callout_colorF = '<div class="ipd-stat-score" style="background-color:#41b6c4;color:#fff"> average</div>'  ;}
        else if (props.SexFem_S_1 == 1 ){ var callout_colorF = '<div class="ipd-stat-score" style="background-color:#a1dab4;color:#fff"> below average</div>'  ;}
        else { var callout_colorF = '<div class="ipd-stat-score" style="background-color:#ffffcc;color:#1a2a2a;"> well below average</div>';}

        if (props.RaceMin_11 == 4 ){ var callout_colorRM = '<div class="ipd-stat-score" style="background-color:#253494;color:#fff"> well above average</div>'  ;}
        else if (props.RaceMin_11 == 3 ){ var callout_colorRM = '<div class="ipd-stat-score" style="background-color:#2c7fb8;color:#fff"> above average</div>'  ;}
        else if (props.RaceMin_11 == 2 ){ var callout_colorRM = '<div class="ipd-stat-score" style="background-color:#41b6c4;color:#fff"> average</div>'  ;}
        else if (props.RaceMin_11 == 1 ){ var callout_colorRM = '<div class="ipd-stat-score" style="background-color:#a1dab4;color:#fff"> below average</div>'  ;}
        else { var callout_colorRM = '<div class="ipd-stat-score" style="background-color:#ffffcc;color:#1a2a2a;"> well below average</div>';}

        if (props.EthnMin_11 == 4 ){ var callout_colorEM = '<div class="ipd-stat-score" style="background-color:#253494;color:#fff"> well above average</div>'  ;}
        else if (props.EthnMin_11 == 3 ){ var callout_colorEM = '<div class="ipd-stat-score" style="background-color:#2c7fb8;color:#fff"> above average</div>'  ;}
        else if (props.EthnMin_11 == 2 ){ var callout_colorEM = '<div class="ipd-stat-score" style="background-color:#41b6c4;color:#fff"> average</div>'  ;}
        else if (props.EthnMin_11 == 1 ){ var callout_colorEM = '<div class="ipd-stat-score" style="background-color:#a1dab4;color:#fff"> below average</div>'  ;}
        else { var callout_colorEM = '<div class="ipd-stat-score" style="background-color:#ffffcc;color:#1a2a2a;"> well below average</div>';}

        if (props.FornBorn_7 == 4 ){ var callout_colorFB = '<div class="ipd-stat-score" style="background-color:#253494;color:#fff"> well above average</div>'  ;}
        else if (props.FornBorn_7 == 3 ){ var callout_colorFB = '<div class="ipd-stat-score" style="background-color:#2c7fb8;color:#fff"> above average</div>'  ;}
        else if (props.FornBorn_7 == 2 ){ var callout_colorFB = '<div class="ipd-stat-score" style="background-color:#41b6c4;color:#fff"> average</div>'  ;}
        else if (props.FornBorn_7 == 1 ){ var callout_colorFB = '<div class="ipd-stat-score" style="background-color:#a1dab4;color:#fff"> below average</div>'  ;}
        else { var callout_colorFB = '<div class="ipd-stat-score" style="background-color:#ffffcc;color:#1a2a2a;"> well below average</div>';}

        if (props.LEP_StdB_1 == 4 ){ var callout_colorLEP = '<div class="ipd-stat-score" style="background-color:#253494;color:#fff"> well above average</div>'  ;}
        else if (props.LEP_StdB_1 == 3 ){ var callout_colorLEP = '<div class="ipd-stat-score" style="background-color:#2c7fb8;color:#fff"> above average</div>'  ;}
        else if (props.LEP_StdB_1 == 2 ){ var callout_colorLEP = '<div class="ipd-stat-score" style="background-color:#41b6c4;color:#fff"> average</div>'  ;}
        else if (props.LEP_StdB_1 == 1 ){ var callout_colorLEP = '<div class="ipd-stat-score" style="background-color:#a1dab4;color:#fff"> below average</div>'  ;}
        else { var callout_colorLEP = '<div class="ipd-stat-score" style="background-color:#ffffcc;color:#1a2a2a;"> well below average</div>';}

        if (props.Disabled_7 == 4 ){ var callout_colorD = '<div class="ipd-stat-score" style="background-color:#253494;color:#fff"> well above average</div>'  ;}
        else if (props.Disabled_7 == 3 ){ var callout_colorD = '<div class="ipd-stat-score" style="background-color:#2c7fb8;color:#fff"> above average</div>'  ;}
        else if (props.Disabled_7 == 2 ){ var callout_colorD = '<div class="ipd-stat-score" style="background-color:#41b6c4;color:#fff"> average</div>'  ;}
        else if (props.Disabled_7 == 1 ){ var callout_colorD = '<div class="ipd-stat-score" style="background-color:#a1dab4;color:#fff"> below average</div>'  ;}
        else { var callout_colorD = '<div class="ipd-stat-score" style="background-color:#ffffcc;color:#1a2a2a;"> well below average</div>';}

        if (props.LowInc_S_1 == 4 ){ var callout_colorLI = '<div class="ipd-stat-score" style="background-color:#253494;color:#fff"> well above average</div>'  ;}
        else if (props.LowInc_S_1 == 3 ){ var callout_colorLI = '<div class="ipd-stat-score" style="background-color:#2c7fb8;color:#fff"> above average</div>'  ;}
        else if (props.LowInc_S_1 == 2 ){ var callout_colorLI = '<div class="ipd-stat-score" style="background-color:#41b6c4;color:#fff"> average</div>'  ;}
        else if (props.LowInc_S_1 == 1 ){ var callout_colorLI = '<div class="ipd-stat-score" style="background-color:#a1dab4;color:#fff"> below average</div>'  ;}
        ...
        var tractdata =  "<div><h3><i aria-hidden='true' class='far fa-address-card fa-2x'></i>&nbsp;&nbsp;IPD Indicators&nbsp;&nbsp;<sup><i class='glyphicon glyphicon-info-sign' id='info-icon' onclick='legendraw()'></i></sup></h3></div>"
                         ...
                         +"<div id='indicator-callout'><span class='ipd-stat'>" + numeral(props.AgeYouth_P).format('0.0%') +"</span><span class='ipd-stat-moe'>+/-  " + numeral(props.AgeYouth_3).format('0.0%') +"</span><br><span class='ipd-stat-footer'> of residents are under the age of 18</span>"+ callout_colorY +"</div></div>"
                         +"<div class='col-md-6'>"
                         ...
                         +"<div id='indicator-callout'><span class='ipd-stat'>"+numeral(props.AgeOlder_4).format('0.0%') +"</span><span class='ipd-stat-moe'>+/-  " + numeral(props.AgeOlder_5).format('0.0%') +"</span><br><span class='ipd-stat-footer'> of residents are over the age of 65 </span>"+ callout_colorOA +"</div></div>"
                         +"</div>"
                         +"<div class='row'>"
                         +"<div class='col-md-6'>"
                         +"<div class='tooltip-IPD-info'>Female<span class='tooltip-IPD-info-text'>Percent population that are female</span></div>"
                         +"<div id='indicator-callout'><span class='ipd-stat'>"+numeral(props.SexFem_Per).format('0.0%') +"</span><span class='ipd-stat-moe'>+/-  " + numeral(props.SexFem_P_1).format('0.0%') +"</span><br><span class='ipd-stat-footer'> of residents are female</span>"+ callout_colorF +"</div></div>"
                         +"<div class='col-md-6'>"
                         ...
                         +"<div id='indicator-callout'><span class='ipd-stat'>" + numeral(props.RaceMino_3).format('0.0%') +"</span><span class='ipd-stat-moe'>+/-  " + numeral(props.RaceMino_4).format('0.0%') +"</span><br><span class='ipd-stat-footer'> of residents self-identify as one or more of the following races</span>"+ callout_colorRM +" </div></div>"
                         +"</div>"
                         +"<div class='row'>"
                         +"<div class='col-md-6'>"
                         ...
                         +"<div id='indicator-callout' ><span class='ipd-stat'>"+numeral(props.FornBorn_P).format('0.0%') +"</span><span class='ipd-stat-moe'>+/-  " + numeral(props.FornBorn_3).format('0.0%') +"</span><br><span class='ipd-stat-footer'> of residents self-identify as born outside of the United States</span>"+ callout_colorFB +"</div></div>"
                         +"</div>"
                         +"<div class='row'>"
                         +"<div class='col-md-6'>"
                         ...
                         +"<div id='indicator-callout'><span class='ipd-stat'>" + numeral(props.LEP_PercEs).format('0.0%') +"</span><span class='ipd-stat-moe'>+/-  " + numeral(props.LEP_Perc_Mo).format('0.0%') +"</span><br><span class='ipd-stat-footer'> of residents self-identify as having limited English proficiency</span>"+ callout_colorLEP +" </div></div>"
                         +"<div class='col-md-6'>"
                         ...
                         +"<div id='indicator-callout'><span class='ipd-stat'>"+numeral(props.Disabled_P).format('0.0%') +"</span><span class='ipd-stat-moe'>+/-  " + numeral(props.Disabled_3).format('0.0%') +"</span><br><span class='ipd-stat-footer'> of residents with one or more physical and/or mental disabilities</span>"+ callout_colorD +"</div></div>"
                         +"</div>"
                         +"<div class='row'>"
                         +"<div class='col-md-6'>"
                         ...
                         +"<div id='indicator-callout'><span class='ipd-stat'>"+numeral(props.LowInc_Per).format('0.0 %') +"</span><span class='ipd-stat-moe'>+/-  " + numeral(props.LowInc_P_1).format('0.0%') +"</span><br><span class='ipd-stat-footer'> of residents with incomes below the poverty threshold</span>"+ callout_colorLI +"</div></div>"
                         +"</div>"
