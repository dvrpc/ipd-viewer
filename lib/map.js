      ...
      function myHandler(){
        EXTODdraw(myHandler.caller.arguments[0].target.dataset.id);
      }
      ...
      $.getJSON("https://opendata.arcgis.com/datasets/ab586640e7ab40e58c0615f9355cb35a_0.geojson", function(data) {
            IPD.addData(data);
      });  
...
//        var locationinfo = "<div class='location-list'>"+(props.MUN1)+", "+(props.CNTY_NAME)+" County <br><p style='font-size:16px'>Census Tract :<a href='https://factfinder.census.gov/bkmk/table/1.0/en/ACS/16_5YR/DP05/1400000US" + (props.GEOID10) + "' target='_blank' rel='noopener' class='location-list-link'> "+(props.NAME10)+"</a></p></div>"
  ...
  var tractuniverse ="<div>"+ numeral(props.U_TPOPEST).format('0,0') +" estimated total population<span class='ipd-stat-moe'>+/-  " + numeral(props.U_TPOPMOE).format('0,0') +"</span><br>"
//                    + numeral(props.U_POP6_EST).format('0,0') +" estimated total population over 5 <span class='ipd-stat-moe'>+/-  " + numeral(props.U_POP6_MOE).format('0,0') +"</span><br>"
//                    + numeral(props.U_PPOVEST).format('0,0') +" estimated total populations in poverty <span class='ipd-stat-moe'>+/-  " + numeral(props.U_PPOVMOE).format('0,0') +"</span><br>"
//                    + numeral(props.U_PNICEST).format('0,0') +" estimated non-institutional civilized pop.<span class='ipd-stat-moe'>+/-  " + numeral(props.U_PNICMOE).format('0,0') +"</span><br>"
                    +"</div>"
  ...
  var tractdata =  "<div><h3 style='text-align: center;'><i aria-hidden='true' class='far fa-address-card fa-2x'></i>&nbsp;&nbsp;IPD Indicators&nbsp;&nbsp;<sup><i class='glyphicon glyphicon-info-sign' id='info-icon' onclick='legendraw()'></i></sup></h3></div>"
                   +"<div class='ipd-chart-info'>The information below provides the estimated percentages, Margin of Error (MOE), and IPD Score Classification of our nine indicators in reference to U.S Census Tract <a href='https://factfinder.census.gov/bkmk/table/1.0/en/ACS/16_5YR/DP05/1400000US" + (props.GEOID10) + "' target='_blank' rel='noopener' class='ipd-indicator-tract'>"+(props.NAME10)+"</a>. The entire set of indicators data and scores may be downloaded from our Open Data Portal for further analysis.</div>"
                   +"<div class='row'>"
                   +"<div class='col-md-6'>"
                   +"<div class='tooltip-IPD-info' data-id='Youth1' onClick='myHandler()'>Youth <sup><i class='glyphicon glyphicon-info-sign'></i></sup><span class='tooltip-IPD-info-text'>Learn more about this indicator</span></div>"
                   +"<div class='indicator-callout'><span class='ipd-stat'>" + numeral(props.Y_PCTEST).format('0.0%') +"</span><span class='ipd-stat-moe'>+/-  " + numeral(props.Y_PCTMOE).format('0.0%') +"</span><br><span class='ipd-stat-footer'> of residents are 18 years or younger</span>"+ callout_colorY +"</div></div>"
                   +"<div class='col-md-6'>"
                   +"<div class='tooltip-IPD-info-top' data-id='Older1' onClick='myHandler()'>Older Adults <sup><i class='glyphicon glyphicon-info-sign'></i></sup><span class='tooltip-IPD-info-top-text'>Learn more about this indicator</span></div>"
                   +"<div class='indicator-callout'><span class='ipd-stat'>"+numeral(props.OA_PCTEST).format('0.0%') +"</span><span class='ipd-stat-moe'>+/-  " + numeral(props.OA_PCTMOE).format('0.0%') +"</span><br><span class='ipd-stat-footer'> of residents are 65 years or older </span>"+ callout_colorOA +"</div></div>"
                   +"</div>"
                   +"<div class='row'>"
                   +"<div class='col-md-6'>"
                   +"<div class='tooltip-IPD-info' data-id='Female1' onClick='myHandler()'>Female <sup><i class='glyphicon glyphicon-info-sign'></i></sup><span class='tooltip-IPD-info-text'>Learn more about this indicator</span></div>"
                   +"<div class='indicator-callout'><span class='ipd-stat'>"+numeral(props.F_PCTEST).format('0.0%') +"</span><span class='ipd-stat-moe'>+/-  " + numeral(props.F_PCTMOE).format('0.0%') +"</span><br><span class='ipd-stat-footer'> residents are female</span>"+ callout_colorF +"</div></div>"
                   +"<div class='col-md-6'>"
                   +"<div class='tooltip-IPD-info-top' data-id='Racial1' onClick='myHandler()'>Racial Minority <sup><i class='glyphicon glyphicon-info-sign' id='Racial1'></i></sup> <span class='tooltip-IPD-info-top-text'>Learn more about this indicator</span></div>"
                   +"<div class='indicator-callout'><span class='ipd-stat'>" + numeral(props.RM_PCTEST).format('0.0%') +"</span><span class='ipd-stat-moe'>+/-  " + numeral(props.RM_PCTMOE).format('0.0%') +"</span><br><span class='ipd-stat-footer'> of residents identify as one or more races considered under Title VI and EJ</span>"+ callout_colorRM +" </div></div>"
                   +"</div>"
                   +"<div class='row'>"
                   +"<div class='col-md-6'>"
                   +"<div class='tooltip-IPD-info' data-id='Ethnic1' onClick='myHandler()'>Ethnic Minority <sup><i class='glyphicon glyphicon-info-sign'></i></sup><span class='tooltip-IPD-info-text'>Learn more about this indicator </span></div>"
                   +"<div class='indicator-callout'><span class='ipd-stat'>"+numeral(props.EM_PCTEST).format('0.0%') +"</span><span class='ipd-stat-moe'>+/-  " + numeral(props.EM_PCTMOE).format('0.0%') +"</span><br><span class='ipd-stat-footer'>  of residents identified themselves as being of Hispanic or Spanish origin. </span>"+ callout_colorEM +"</div></div>"
                    +"<div class='col-md-6'>"
                   +"<div class='tooltip-IPD-info-top' data-id='Foreign1' onClick='myHandler()'>Foreign Born <sup><i class='glyphicon glyphicon-info-sign'></i></sup><span class='tooltip-IPD-info-top-text'>Learn more about this indicator</span></div>"
                   +"<div class='indicator-callout' ><span class='ipd-stat'>"+numeral(props.FB_PCTEST).format('0.0%') +"</span><span class='ipd-stat-moe'>+/-  " + numeral(props.FB_PCTMOE).format('0.0%') +"</span><br><span class='ipd-stat-footer'> of residents were born outside of the United States</span>"+ callout_colorFB +"</div></div>"
                   +"</div>"
                   +"<div class='row'>"
                   +"<div class='col-md-6'>"
                   +"<div class='tooltip-IPD-info' data-id='LEP1' onClick='myHandler()'> Limited English Proficiency <sup><i class='glyphicon glyphicon-info-sign'></i></sup> <span class='tooltip-IPD-info-text'>Learn more about this indicator </span></div>"
                   +"<div class='indicator-callout'><span class='ipd-stat'>" + numeral(props.LEP_PCTEST).format('0.0%') +"</span><span class='ipd-stat-moe'>+/-  " + numeral(props.LEP_PCTMOE).format('0.0%') +"</span><br><span class='ipd-stat-footer'> of residents report having English proficiency below “very well”</span>"+ callout_colorLEP +" </div></div>"
                   +"<div class='col-md-6'>"
                   +"<div class='tooltip-IPD-info-top' data-id='Disabled1' onClick='myHandler()'> Disabled <sup><i class='glyphicon glyphicon-info-sign'></i></sup> <span class='tooltip-IPD-info-top-text'>Learn more about this indicator </span></div>"
                   +"<div class='indicator-callout'><span class='ipd-stat'>"+numeral(props.D_PCTEST).format('0.0%') +"</span><span class='ipd-stat-moe'>+/-  " + numeral(props.D_PCTMOE).format('0.0%') +"</span><br><span class='ipd-stat-footer'> of residents with one or more physical and/or mental disabilities</span>"+ callout_colorD +"</div></div>"
                   +"</div>"
                   +"<div class='row'>"
                   +"<div class='col-md-6'>"
                   +"<div class='tooltip-IPD-info' data-id='Low-Income1' onClick='myHandler()'>Low-Income <sup><i class='glyphicon glyphicon-info-sign'></i></sup><span class='tooltip-IPD-info-text'>Learn more about this indicator </span></div>"
                   +"<div class='indicator-callout'><span class='ipd-stat'>"+numeral(props.LI_PCTEST).format('0.0 %') +"</span><span class='ipd-stat-moe'>+/-  " + numeral(props.LI_PCTMOE).format('0.0%') +"</span><br><span class='ipd-stat-footer'> of residents live in households with an income below 200% of the national poverty level</span>"+ callout_colorLI +"</div></div>"
                   +"</div>"
   ...
   //    console.log(bikeindata);
      ...
      L.Control.MapLegend = L.Control.extend({
        ...
        onAdd: function (map) {
            ...
            legend_body.innerHTML += '<div id="legend-content">'+
           ...
           legend_top.innerHTML += '<p id="legend-title-content"><b>IPD Score Analysis</b></p>'
      ...
      $("#layer-change").children().on('click', function(){
        ...
        // change the legend to reflect the new text!
