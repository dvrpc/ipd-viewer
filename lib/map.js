 ...
 //     $.getJSON("https://opendata.arcgis.com/datasets/418897de5e97478eb70da54bc1912f32_2.geojson", function(data) {
      ...
      $.getJSON("https://arcgis.dvrpc.org/portal/rest/services/Demographics/IPD_2018/FeatureServer/0/query?where=u_tpopest+%3C+0&outFields=*&returnGeometry=true&outSR=4326&&f=geojson", function(data) {
            NODATA.addData(data);
      });   
 ...
 // https://services1.arcgis.com/LWtWv6q6BJyKidj8/arcgis/rest/services/IPD_2018/FeatureServer/0/query?where=u_tpopest+%3E+0&outFields=*&returnGeometry=true&outSR=4326&&f=pgeojson
      ...
      $.getJSON("https://arcgis.dvrpc.org/portal/rest/services/Demographics/IPD_2018/FeatureServer/0/query?where=u_tpopest+%3E+0&outFields=*&returnGeometry=true&outSR=4326&&f=geojson", function(data) {
            IPD.addData(data);
      });  
 ...
 // https://data.census.gov/cedsci/table?g=1400000US42017100102&hidePreview=true&tid=ACSDP5Y2018.DP05&table=DP05
        var locationinfo = "<div class='location-list'>"+(props.mun1)+", "+(props.cnty_name)+" County <br><p style='font-size:16px'>Census Tract :<a href='https://data.census.gov/cedsci/table?g=1400000US" + (props.geoid10) + "&hidePreview=true&tid=ACSDP5Y2018.DP05&table=DP05' target='_blank' rel='noopener' class='location-list-link'> "+(props.tract_numb)+"</a></p></div>"
