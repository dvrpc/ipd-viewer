...
//                    + numeral(props.U_PNICEST).format('0,0') +" estimated non-institutional civilized pop.<span class='ipd-stat-moe'>+/-  " + numeral(props.U_PNICMOE).format('0,0') +"</span><br>"
  ...
  var tractdata =  "<div><h3 style='text-align: center;'><i aria-hidden='true' class='far fa-address-card fa-2x'></i>&nbsp;&nbsp;IPD Indicators&nbsp;&nbsp;<i class='glyphicon glyphicon-info-sign' id='sup-info-icon'data-id='IPD1' onClick='myHandler()'></i></h3></div>"
                   ...
                   +"<div class='indicator-callout'><span class='ipd-stat'>" + numeral(props.Y_PctEst).format('0.0%') +"</span><span class='ipd-stat-moe'>+/-  " + numeral(props.Y_PctMOE).format('0.0%') +"</span><br><span class='ipd-stat-footer'> of residents are under 18 years old</span>"+ callout_colorY +"</div></div>"
                   +"<div class='col-md-6'>"
