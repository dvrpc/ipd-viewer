  ...
  //     });
      ...
      function identify(e) {
        ...
        var tractdata =  "<div><h3><i aria-hidden='true' class='far fa-address-card fa-2x'></i>&nbsp;&nbsp;IPD Indicators&nbsp;&nbsp;<sup><i class='glyphicon glyphicon-info-sign' id='info-icon' onclick='legendraw()'></i></sup></h3></div>"
                         +"<div class='ipd-chart-info'>The information below provides tract-level estimated percentages, Margin of Error (MOE), and IPD Score Analysis for our nine indicators. The entire set of indicators data and scores may be downloaded from our Open Data Portal for further analysis.</div>"
                         +"<div class='row'>"
                         +"<div class='col-md-6'>"
   ...
   */      tooltip: {
   ...
   //    console.log(bikeindata);
      ...
      $("#layer-change").children().on('click', function(){
        ...
        $("#legend-title-content").text(newLayer+" Score");
      });
      /*
