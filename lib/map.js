  ...
  //     });
      ...
      function identify(e) {
        ...
        var tractdata =  "<div><h3><i aria-hidden='true' class='fa fa-bar-chart'></i>&nbsp;&nbsp;IPD Indicators&nbsp;&nbsp;<sup><i class='glyphicon glyphicon-info-sign' id='info-icon' onclick='legendraw()'></i></sup></h3></div>"
                         ...
                         +"<div id='indicator-callout'><span class='ipd-stat'>" + numeral(props.AgeYouth_P).format('0.0%') +"</span><span class='ipd-stat-moe'>+/-  " + numeral(props.AgeYouth_3).format('0.0%') +"</span><br><span class='ipd-stat-footer'> of residents are under the age of 18</span> </div></div>"
                         +"<div class='col-md-6'>"
