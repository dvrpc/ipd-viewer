...
// IPD Group Histogram Chart  
    $(function () {
      ...
      //Older Adults
      var xAxisLabels2 = {categories: ['0.0% to 5.3%','5.4% to 12.4%', '12.5% to 19.5%', '19.6% to 26.6%', '26.7% to 100.0%']};
      //Female
      var xAxisLabels3 = {categories: ['0.0% to 44.9%','45.0% to 49.4%', '49.5% to 53.9%', '54.0% to 58.4%', '58.5% to 100.0%']};
      //RM
      var xAxisLabels4 = {categories: ['0.0% to 0.0%','0.1% to 19.5%', '19.6% to 48.7%', '48.8% to 77.9%', '78.0% to 100.0%']};
      //EM
      var xAxisLabels5 = {categories: ['0.0% to 0.0%','0.1% to 2.9%', '3.0% to 16.2%', '16.3% to 29.4%', '29.5% to 100.0%']};
      //FB
      var xAxisLabels6 = {categories: ['0.0% to 0.0%','0.1% to 6.6%', '6.7% to 15.5%', '15.6% to 24.4%', '24.5% to 100.0%']};
      //LEP
      var xAxisLabels7 = {categories: ['0.0% to 0.0%','0.1% to 2.4%', '2.5% to 10.2%', '10.3% to 17.9%', '18.0% to 100.0%']};
      //Disabled
      var xAxisLabels8 = {categories: ['0.0% to 4.3%','4.4% to 10.0%', '10.1% to 15.7%', '15.8% to 21.4%', '21.5% to 100.0%']};
      //Low Income
      var xAxisLabels9 = {categories: ['0.0% to 0.0%','0.1% to 16.7%', '16.8% to 36.5%', '36.6% to 56.5%', '56.6% to 100.0%']};
