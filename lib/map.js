...
//Census Tracts with NO Data
      $.getJSON("https://arcgis.dvrpc.org/portal/rest/services/Demographics/ipd_2021/FeatureServer/0/query?where=u_tpopest+%3C+0&outFields=*&returnGeometry=true&outSR=4326&&f=geojson", function(data) {
            NODATA.addData(data);
      });   
         ...
         style: getIMDStyle,
          onEachFeature: function (feature, layer) {
            feature.id = L.stamp(layer);
             ...
             //   var mcd2 = ;
                if (feature.properties.mun2 == null  ){ var mcd2 = '<br><B>Municipality</B>: '+ feature.properties.mun1 ;}
                else { var mcd2 ='<br><B>Municipalities</B>: '+ feature.properties.mun1 + ',<br>' + feature.properties.mun2;}
                if (feature.properties.mun3 == null  ){ var mcd3 = '';}
...
// IPD dataset filtering No Data
      $.getJSON("https://arcgis.dvrpc.org/portal/rest/services/Demographics/ipd_2021/FeatureServer/0/query?where=u_tpopest+%3E+0&outFields=*&returnGeometry=true&outSR=4326&&f=geojson", function(data) {
        IPD.addData(data);
      });  
  ...
  //Basemap Layers
      ...
      function identify(e) {
        ...
        var locationinfo = "<div class='location-list'>"+(props.mun1)+", "+ county +" County <br><p style='font-size:16px'>Census Tract :<a href='https://data.census.gov/cedsci/table?g=1400000US" + (props.geoid20) + "&hidePreview=true&tid=ACSDP5Y2021.DP05&table=DP05' target='_blank' rel='noopener' class='location-list-link'> "+(props.namelsad)+"</a></p></div>"
...
// IPD Group Histogram Chart  
    $(function () {
      //Youth
      var xAxisLabels  = {categories: ['0.0% to 11.3%','11.4% to 17.9%', '18.0% to 24.5%', '24.6% to 31.1%', '31.2% to 100.0%']};
      //Older Adults
      var xAxisLabels2 = {categories: ['0.0% to 5.1%','5.2% to 12.6%', '12.7% to 20.0%', '20.1% to 27.4%', '27.5% to 100.0%']};
      //Female
      var xAxisLabels3 = {categories: ['0.0% to 45.0%','45.1% to 49.2%', '49.3% to 53.6%', '53.7% to 58.0%', '58.1% to 100.0%']};
      //RM
      var xAxisLabels4 = {categories: ['0.0% to 0.1%','0.2% to 21.9%', '22.0% to 50.1%', '50.2% to 79.8%', '79.9% to 100.0%']};
      //EM
      var xAxisLabels5 = {categories: ['0.0% to 0.1%','0.2% to 3.2%', '3.3% to 16.9%', '17.0% to 30.5%', '30.6% to 100.0%']};
      //FB
      var xAxisLabels6 = {categories: ['0.0% to 0.1%','0.2% to 6.9%', '7.0% to 16.1%', '16.2% to 25.3%', '25.4% to 100.0%']};
      //LEP
      var xAxisLabels7 = {categories: ['0.0% to 0.1%','0.2% to 2.6%', '2.7% to 10.5%', '10.6% to 18.4%', '18.5% to 100.0%']};
      //Disabled
      var xAxisLabels8 = {categories: ['0.0% to 3.4%','3.5% to 9.7%', '9.8% to 16.0%', '16.2% to 22.2%', '22.3% to 100.0%']};
      //Low Income
      var xAxisLabels9 = {categories: ['0.0% to 0.1%','0.2% to 15.7%', '15.8% to 34.8%', '34.9% to 54.0%', '54.1% to 100.0%']};
      ...
      $('#layer-change li:eq(1)').click(function(){
         chart.series[0].setData([{y:84,color:'#ffffcc'},   {y:302,color:'#a1dab4'},   {y:621,color:'#41b6c4'},   {y:322,color:'#2c7fb8'},   {y:87,color:'#253494'}] );
      ...
      $('#layer-change li:eq(2)').click(function() {
          chart.series[0].setData([{y:34,color:'#ffffcc'},   {y:416,color:'#a1dab4'},   {y:624,color:'#41b6c4'},   {y:243,color:'#2c7fb8'},   {y:99,color:'#253494'}] );
          chart.yAxis[0].setExtremes(0,900);
          chart.update({
             tooltip: {
                  enabled: true,
      ...
      $('#layer-change li:eq(3)').click(function() {
          chart.series[0].setData([{y:80,color:'#ffffcc'},   {y:323,color:'#a1dab4'},   {y:614,color:'#41b6c4'},   {y:309,color:'#2c7fb8'},  {y:90,color:'#253494'}] );
          chart.yAxis[0].setExtremes(0,900);
          chart.update({
             tooltip: {
                  enabled: true,
       ...
       $('#layer-change li:eq(4)').click(function() {
          chart.series[0].setData([{y:1,color:'#ffffcc'},    {y:618,color:'#a1dab4'},   {y:415,color:'#41b6c4'},   {y:181,color:'#2c7fb8'},  {y:202,color:'#253494'}] );
          chart.yAxis[0].setExtremes(0,900);
          chart.update({
             tooltip: {
                  enabled: true,
      ...
      $('#layer-change li:eq(5)').click(function() {
          chart.series[0].setData([{y:31,color:'#ffffcc'},   {y:393,color:'#a1dab4'},   {y:780,color:'#41b6c4'},   {y:114,color:'#2c7fb8'},   {y:98,color:'#253494'}] );
          chart.yAxis[0].setExtremes(0,900);
          chart.update({
             tooltip: {
                  enabled: true,
      ...
      $('#layer-change li:eq(6)').click(function() {
          chart.series[0].setData([{y:5,color:'#ffffcc'},    {y:531,color:'#a1dab4'},   {y:557,color:'#41b6c4'},   {y:209,color:'#2c7fb8'},  {y:114,color:'#253494'}] );
          chart.yAxis[0].setExtremes(0,900);
          chart.update({
             tooltip: {
                  enabled: true,
      ...
      $('#layer-change li:eq(7)').click(function() {
          chart.series[0].setData([{y:51,color:'#ffffcc'},   {y:464,color:'#a1dab4'},  {y:652,color:'#41b6c4'},  {y:128,color:'#2c7fb8'},  {y:121,color:'#253594'}] );
          chart.yAxis[0].setExtremes(0,900);
          chart.update({
             tooltip: {
                  enabled: true,
      ...
      $('#layer-change li:eq(8)').click(function() {
          chart.series[0].setData([{y:11,color:'#ffffcc'},   {y:495,color:'#a1dab4'},  {y:555,color:'#41b6c4'},  {y:245,color:'#2c7fb8'},  {y:110,color:'#253594'}] );
          chart.yAxis[0].setExtremes(0,900);
          chart.update({
             tooltip: {
                  enabled: true,
      ...
      $('#layer-change li:eq(9)').click(function() {
          chart.series[0].setData([{y:2,color:'#ffffcc'},{y:595,color:'#a1dab4'},  {y:443,color:'#41b6c4'},  {y:218,color:'#2c7fb8'},  {y:158,color:'#253594'}] );
          chart.yAxis[0].setExtremes(0,900);
          chart.update({
             tooltip: {
                  enabled: true,
