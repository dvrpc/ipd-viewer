            ...
            onEachFeature: function (feature, layer) {
              feature.id = L.stamp(layer);
                 if (feature.properties) {
                      layer.bindLabel('<u>'+feature.properties.GEOID10 + '</u><br>IPD Composite Score:&nbsp'+ feature.properties.NewScoreMe , {
    ...
    function identify(e) {
        ...
        var existingOVinfo = "<div><i class='glyphicon glyphicon-info-sign' id='info-icon' onclick='legendraw()'></i><b>Existing TOD Orientation</b></div>"
   ...
   //    e.preventDefault();
    ...
    var options = {
       ...
       ,
        ...
        xAxis: {
            categories: [ 'Youth','Older Adults','Female','Racial Minority','Ethnic Minority','Foreign Born','Limited English Proficiency','Disabled','Low-Income'],
