  ...
  //     });
      ...
      function identify(e) {
        ...
        var tractdata =  "<div><h3><i aria-hidden='true' class='far fa-address-card fa-2x'></i>&nbsp;&nbsp;IPD Indicators&nbsp;&nbsp;<sup><i class='glyphicon glyphicon-info-sign' id='info-icon' onclick='legendraw()'></i></sup></h3></div>"
                         ...
                         +"<div class='col-md-6'>"
                         +"<div class='tooltip-IPD-info' id='Racial1' onClick=myHandler()>Racial Minority <sup><i class='glyphicon glyphicon-info-sign' id='Racial1'></i></sup> <span class='tooltip-IPD-info-text'>Learn more about this indicator</span></div>"
                         ...
                         +"<div id='indicator-callout'><span class='ipd-stat'>"+numeral(props.EM_PctEst).format('0.0%') +"</span><span class='ipd-stat-moe'>+/-  " + numeral(props.EM_PctMOE).format('0.0%') +"</span><br><span class='ipd-stat-footer'> of residents identified themselves as being of Hispanic, Latino, Spanish, Mexican, Chicano, Cuban, Puerto Rican, or Other Hispanic origin. </span>"+ callout_colorEM +"</div></div>"
                          +"<div class='col-md-6'>"
                         +"<div class='tooltip-IPD-info' id='Foreign1' onClick=myHandler()>Foreign Born <sup><i class='glyphicon glyphicon-info-sign' id='Foreign1'></i></sup><span class='tooltip-IPD-info-text'>Learn more about this indicator</span></div>"
                         ...
                         +"<div class='col-md-6'>"
                         +"<div class='tooltip-IPD-info' id='Disabled1' onClick=myHandler()> Disabled <sup><i class='glyphicon glyphicon-info-sign' id='Disabled1'></i></sup> <span class='tooltip-IPD-info-text'>Learn more about this indicator </span></div>"
...
// IPD Group Histogram Chart  
    $(function () {
      ...
      var xAxisLabels4 = {categories: ['0.0% to 4.7%','4.8% to 11.5%', '11.6% to 18.2%', '18.3% to 24.9%', '25.0% to 100.0%']};
      
      var xAxisLabels5  = {categories: ['0.0% to 12.4%','12.5% to 18.6%', '18.7% to 24.8%', '24.9% to 31.0%', '31.1% to 100.0%']};
      var xAxisLabels6 = {categories: ['0.0% to 4.7%','4.8% to 11.5%', '11.6% to 18.2%', '18.3% to 24.9%', '25.0% to 100.0%']};
      var xAxisLabels7  = {categories: ['0.0% to 12.4%','12.5% to 18.6%', '18.7% to 24.8%', '24.9% to 31.0%', '31.1% to 100.0%']};
      var xAxisLabels8 = {categories: ['0.0% to 4.7%','4.8% to 11.5%', '11.6% to 18.2%', '18.3% to 24.9%', '25.0% to 100.0%']};
      var xAxisLabels9 = {categories: ['0.0% to 4.7%','4.8% to 11.5%', '11.6% to 18.2%', '18.3% to 24.9%', '25.0% to 100.0%']};
