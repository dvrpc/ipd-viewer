...
//                    + numeral(props.U_PNICEST).format('0,0') +" estimated non-institutional civilized pop.<span class='ipd-stat-moe'>+/-  " + numeral(props.U_PNICMOE).format('0,0') +"</span><br>"
  ...
  var tractdata =  "<div><h3 style='text-align: center;'><i aria-hidden='true' class='far fa-address-card fa-2x'></i>&nbsp;&nbsp;IPD Indicators&nbsp;&nbsp;<sup><i class='glyphicon glyphicon-info-sign' id='info-icon' onclick='legendraw()'></i></sup></h3></div>"
                   ...
                   +"<div class='row'>"
                   +"<div class='col-md-6'>"
                   +"<div class='tooltip-IPD-info' id='Youth1' onClick=myHandler() >Youth <sup><i class='glyphicon glyphicon-info-sign' id='Youth1'></i></sup><span class='tooltip-IPD-info-text'>Learn more about this indicator</span></div>"
                   +"<div id='indicator-callout'><span class='ipd-stat'>" + numeral(props.Y_PCTEST).format('0.0%') +"</span><span class='ipd-stat-moe'>+/-  " + numeral(props.Y_PCTMOE).format('0.0%') +"</span><br><span class='ipd-stat-footer'> of residents are 18 years or younger</span>"+ callout_colorY +"</div></div>"
                   +"<div class='col-md-6'>"
                   +"<div class='tooltip-IPD-info-top' id='Older1' onClick=myHandler()>Older Adults <sup><i class='glyphicon glyphicon-info-sign' id='Older1'></i></sup><span class='tooltip-IPD-info-top-text'>Learn more about this indicator</span></div>"
                   +"<div id='indicator-callout'><span class='ipd-stat'>"+numeral(props.OA_PCTEST).format('0.0%') +"</span><span class='ipd-stat-moe'>+/-  " + numeral(props.OA_PCTMOE).format('0.0%') +"</span><br><span class='ipd-stat-footer'> of residents are 65 years or older </span>"+ callout_colorOA +"</div></div>"
                   +"</div>"
                   +"<div class='row'>"
                   +"<div class='col-md-6'>"
                   +"<div class='tooltip-IPD-info' id='Female1' onClick=myHandler()>Female <sup><i class='glyphicon glyphicon-info-sign' id='Female1'></i></sup><span class='tooltip-IPD-info-text'>Learn more about this indicator</span></div>"
                   +"<div id='indicator-callout'><span class='ipd-stat'>"+numeral(props.F_PCTEST).format('0.0%') +"</span><span class='ipd-stat-moe'>+/-  " + numeral(props.F_PCTMOE).format('0.0%') +"</span><br><span class='ipd-stat-footer'> residents are female</span>"+ callout_colorF +"</div></div>"
                   +"<div class='col-md-6'>"
                   +"<div class='tooltip-IPD-info-top' id='Racial1' onClick=myHandler()>Racial Minority <sup><i class='glyphicon glyphicon-info-sign' id='Racial1'></i></sup> <span class='tooltip-IPD-info-top-text'>Learn more about this indicator</span></div>"
                   +"<div id='indicator-callout'><span class='ipd-stat'>" + numeral(props.RM_PCTEST).format('0.0%') +"</span><span class='ipd-stat-moe'>+/-  " + numeral(props.RM_PCTMOE).format('0.0%') +"</span><br><span class='ipd-stat-footer'> of residents identify as one or more races considered under Title VI and EJ</span>"+ callout_colorRM +" </div></div>"
                   +"</div>"
                   +"<div class='row'>"
                   +"<div class='col-md-6'>"
                   +"<div class='tooltip-IPD-info' id='Ethnic1' onClick=myHandler()>Ethnic Minority <sup><i class='glyphicon glyphicon-info-sign' id='Ethnic1'></i></sup><span class='tooltip-IPD-info-text'>Learn more about this indicator </span></div>"
                   +"<div id='indicator-callout'><span class='ipd-stat'>"+numeral(props.EM_PCTEST).format('0.0%') +"</span><span class='ipd-stat-moe'>+/-  " + numeral(props.EM_PCTMOE).format('0.0%') +"</span><br><span class='ipd-stat-footer'>  of residents identified themselves as being of Hispanic or Spanish origin. </span>"+ callout_colorEM +"</div></div>"
                    +"<div class='col-md-6'>"
                   +"<div class='tooltip-IPD-info-top' id='Foreign1' onClick=myHandler()>Foreign Born <sup><i class='glyphicon glyphicon-info-sign' id='Foreign1'></i></sup><span class='tooltip-IPD-info-top-text'>Learn more about this indicator</span></div>"
                   +"<div id='indicator-callout' ><span class='ipd-stat'>"+numeral(props.FB_PCTEST).format('0.0%') +"</span><span class='ipd-stat-moe'>+/-  " + numeral(props.FB_PCTMOE).format('0.0%') +"</span><br><span class='ipd-stat-footer'> of residents were born outside of the United States</span>"+ callout_colorFB +"</div></div>"
                   +"</div>"
                   +"<div class='row'>"
                   +"<div class='col-md-6'>"
                   +"<div class='tooltip-IPD-info' id='LEP1' onClick=myHandler()> Limited English Proficiency <sup><i class='glyphicon glyphicon-info-sign' id='LEP1'></i></sup> <span class='tooltip-IPD-info-text'>Learn more about this indicator </span></div>"
                   +"<div id='indicator-callout'><span class='ipd-stat'>" + numeral(props.LEP_PCTEST).format('0.0%') +"</span><span class='ipd-stat-moe'>+/-  " + numeral(props.LEP_PCTMOE).format('0.0%') +"</span><br><span class='ipd-stat-footer'> of residents report having English proficiency below “very well”</span>"+ callout_colorLEP +" </div></div>"
                   +"<div class='col-md-6'>"
                   +"<div class='tooltip-IPD-info-top' id='Disabled1' onClick=myHandler()> Disabled <sup><i class='glyphicon glyphicon-info-sign' id='Disabled1'></i></sup> <span class='tooltip-IPD-info-top-text'>Learn more about this indicator </span></div>"
                   ...
                   +"<div class='row'>"
                   +"<div class='col-md-6'>"
                   +"<div class='tooltip-IPD-info' id='Low-Income1' onClick=myHandler()>Low-Income <sup><i class='glyphicon glyphicon-info-sign' id='Low-Income1'></i></sup><span class='tooltip-IPD-info-text'>Learn more about this indicator </span></div>"
                   +"<div id='indicator-callout'><span class='ipd-stat'>"+numeral(props.LI_PCTEST).format('0.0 %') +"</span><span class='ipd-stat-moe'>+/-  " + numeral(props.LI_PCTMOE).format('0.0%') +"</span><br><span class='ipd-stat-footer'> of residents live in households with an income below 200% of the national poverty level</span>"+ callout_colorLI +"</div></div>"
                   +"</div>"
