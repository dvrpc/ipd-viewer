  ...
  //     });
      ...
      function identify(e) {
        ...
        var locationinfo = "<div class='location-list'>"+(props.MUN1)+", "+(props.CNTY_NAME)+" County <p style='float:right;font-size:16px'>Census Tract: "+(props.NAME10)+"</p></div>"
        ...
        var tractuniverse ="<div> Population: " + (props.NAME10) +" total people<br>"
                          ...
                          +" Households: " + (props.NAME10) +" total households<br>"
                          +"</div>"

        var tractdata =  "<div><h3><i aria-hidden='true' class='fa fa-bar-chart'></i>&nbsp;&nbsp;IPD Indicators&nbsp;&nbsp;<sup><i class='glyphicon glyphicon-info-sign' id='info-icon' onclick='legendraw()'></i></sup></h3></div>"
                         ...
                         +"<div class='row'>"
                         +"<div class='col-md-4'>"
                         +"<div class='tooltip_info'>Youth<span class='tooltip_info_text'>Youth Gone Wild represent those that have lots of young kids in the house</span></div>"
                         +"<div id='indicator-callout'><span class='ipd-stat'>" + numeral(props.AgeYouth_P).format('0.0%') +"</span><br><span class='ipd-stat-footer'> of residents are under the age of 18</span> </div></div>"
                         +"<div class='col-md-4'>"
                         +"<div class='tooltip_info'>Older Adults<span class='tooltip_info_text'>We love to play card games and have fun</span></div>"
                         +"<div id='indicator-callout'><span class='ipd-stat'>"+numeral(props.AgeOlder_4).format('0.0%') +"</span><br><span class='ipd-stat-footer'> of residents are over the age of 65 </span></div></div>"
                          +"<div class='col-md-4'>"
                         +"<div class='tooltip_info'>Female<span class='tooltip_info_text'>Percent population that are female</span></div>"
                         +"<div id='indicator-callout'><span class='ipd-stat'>"+numeral(props.SexFem_Per).format('0.0%') +"</span><br><span class='ipd-stat-footer'> of residents are female</span></div></div>"
                         +"</div>"
                         +"<div class='row'>"
                         +"<div class='col-md-4'>"
                         +"<div class='tooltip_info'>Racial Minority<span class='tooltip_info_text'>percentage of residents self-identify as one or more of the following races: Black or African American, American Indian, Alaskan Native, Asian Indian, Japanese, Native Hawaiian, Chinese, Korean, Guamanian or Chamorro, Filipino, Vietnamese, Samoan, Other Asian, and/or Other Pacific Islander. </span></div>"
                         +"<div id='indicator-callout'><span class='ipd-stat'>" + numeral(props.RaceMino_3).format('0.0%') +"</span><br><span class='ipd-stat-footer'> of residents self-identify as one or more of the following races</span> </div></div>"
                         +"<div class='col-md-4'>"
                         +"<div class='tooltip_info'>Ethnic Minority<span class='tooltip_info_text'>persons in the region who identified themselves as being of Hispanic, Latino, Spanish, Mexican, Chicano, Cuban, Puerto Rican, or Other Hispanic origin. </span></div>"
                         +"<div id='indicator-callout'><span class='ipd-stat'>"+numeral(props.EthnMino_3).format('0.0%') +"</span><br><span class='ipd-stat-footer'> of residents identified themselves as being of Hispanic, Latino, Spanish, Mexican, Chicano, Cuban, Puerto Rican, or Other Hispanic origin. </span></div></div>"
                          +"<div class='col-md-4'>"
                         +"<div class='tooltip_info'>Foreign Born<span class='tooltip_info_text'>Percent population that were born outside of the United States</span></div>"
                         +"<div id='indicator-callout'><span class='ipd-stat'>"+numeral(props.FornBorn_P).format('0.0%') +"</span><br><span class='ipd-stat-footer'> of residents self-identify as born outside of the United States</span></div></div>"
                         +"</div>"
                         +"<div class='row'>"
                         +"<div class='col-md-4'>"
                         +"<div class='tooltip_info'>LEP<span class='tooltip_info_text'>residents self-identify as having limited English proficiency</span></div>"
                         +"<div id='indicator-callout'><span class='ipd-stat'>" + numeral(props.LEP_PercEs).format('0.0%') +"</span><br><span class='ipd-stat-footer'> of residents self-identify as having limited English proficiency</span> </div></div>"
                         +"<div class='col-md-4'>"
                         +"<div class='tooltip_info'>Disabled<span class='tooltip_info_text'>persons in the region with one or more physical and/or mental disabilities </span></div>"
                         +"<div id='indicator-callout'><span class='ipd-stat'>"+numeral(props.Disabled_P).format('0.0%') +"</span><br><span class='ipd-stat-footer'> of residents with one or more physical and/or mental disabilities</span></div></div>"
                          +"<div class='col-md-4'>"
                         +"<div class='tooltip_info'>Low-Income<span class='tooltip_info_text'>Percent population of residents have incomes below the poverty threshold. </span></div>"
                         +"<div id='indicator-callout'><span class='ipd-stat'>"+numeral(props.LowInc_Per).format('0.0 %') +"</span><br><span class='ipd-stat-footer'> of residents with incomes below the poverty threshold</span></div></div>"
                         +"</div>"
