 ...
 //     $.getJSON("https://opendata.arcgis.com/datasets/418897de5e97478eb70da54bc1912f32_2.geojson", function(data) {
      ...
      $.getJSON("https://services1.arcgis.com/LWtWv6q6BJyKidj8/arcgis/rest/services/IPD_2018/FeatureServer/0/query?where=0=0&outFields=*&returnGeometry=true&outSR=4326&&f=pgeojson", function(data) {
            IPD.addData(data);
      });  
