 ...
 //     $.getJSON("https://opendata.arcgis.com/datasets/418897de5e97478eb70da54bc1912f32_2.geojson", function(data) {
      ...
      $.getJSON("https://arcgis.dvrpc.org/portal/rest/services/Demographics/IPD_2019/FeatureServer/0/query?where=u_tpopest+%3C+0&outFields=*&returnGeometry=true&outSR=4326&&f=geojson", function(data) {
            NODATA.addData(data);
      });   
 ...
 // https://services1.arcgis.com/LWtWv6q6BJyKidj8/arcgis/rest/services/IPD_2018/FeatureServer/0/query?where=u_tpopest+%3E+0&outFields=*&returnGeometry=true&outSR=4326&&f=pgeojson
              //   https://arcgis.dvrpc.org/portal/rest/services/Demographics/IPD_2018/FeatureServer/0/query?where=u_tpopest+%3E+0&objectIds=&time=&geometry=&geometryType=esriGeometryEnvelope&inSR=&spatialRel=esriSpatialRelIntersects&distance=&units=esriSRUnit_Foot&relationParam=&outFields=*&returnGeometry=true&maxAllowableOffset=&geometryPrecision=&outSR=4326&having=&gdbVersion=&historicMoment=&returnDistinctValues=false&returnIdsOnly=false&returnCountOnly=false&returnExtentOnly=false&orderByFields=&groupByFieldsForStatistics=&outStatistics=&returnZ=false&returnM=false&multipatchOption=xyFootprint&resultOffset=&resultRecordCount=&returnTrueCurves=false&returnExceededLimitFeatures=false&quantizationParameters=&returnCentroid=false&sqlFormat=none&resultType=&featureEncoding=esriDefault&f=geojson
              //   https://arcgis.dvrpc.org/portal/rest/services/Demographics/IPD_2018/FeatureServer/0/query?where=u_tpopest+%3C+0&outFields=*&returnGeometry=true&outSR=4326&&f=pgeojson
      $.getJSON("https://arcgis.dvrpc.org/portal/rest/services/Demographics/IPD_2019/FeatureServer/0/query?where=u_tpopest+%3E+0&outFields=*&returnGeometry=true&outSR=4326&&f=geojson", function(data) {
            IPD.addData(data);
      });  
 ...
 // https://data.census.gov/cedsci/table?g=1400000US42017100102&hidePreview=true&tid=ACSDP5Y2018.DP05&table=DP05
        var locationinfo = "<div class='location-list'>"+(props.mun1)+", "+(props.cnty_name)+" County <br><p style='font-size:16px'>Census Tract :<a href='https://data.census.gov/cedsci/table?g=1400000US" + (props.geoid10) + "&hidePreview=true&tid=ACSDP5Y2019.DP05&table=DP05' target='_blank' rel='noopener' class='location-list-link'> "+(props.tract_numb)+"</a></p></div>"
...
// IPD Group Histogram Chart  
    $(function () {
      //Youth
      var xAxisLabels  = {categories: ['0.0% to 12.2%','12.3% to 18.3%', '18.4% to 24.4%', '24.5% to 30.5%', '30.6% to 100.0%']};
      //Older Adults
      var xAxisLabels2 = {categories: ['0.0% to 5.1%','5.2% to 12.0%', '12.1% to 18.9%', '19.0% to 25.9%', '26.0% to 100.0%']};
      //Female
      var xAxisLabels3 = {categories: ['0.0% to 44.9%','45.0% to 49.4%', '49.5% to 53.9%', '54.0% to 58.4%', '58.5% to 100.0%']};
      //RM
      var xAxisLabels4 = {categories: ['0.0% to 0.0%','0.1% to 19.1%', '19.2% to 48.4%', '48.5% to 77.6%', '77.7% to 100.0%']};
      //EM
      var xAxisLabels5 = {categories: ['0.0% to 0.0%','0.1% to 2.7%', '2.8% to 15.9%', '16.0% to 29.0%', '29.1% to 100.0%']};
      //FB
      var xAxisLabels6 = {categories: ['0.0% to 0.0%','0.1% to 6.5%', '6.6% to 15.3%', '15.4% to 24.2%', '24.3% to 100.0%']};
      //LEP
      var xAxisLabels7 = {categories: ['0.0% to 0.0%','0.1% to 2.4%', '2.5% to 10.1%', '10.2% to 17.9%', '18.0% to 100.0%']};
      //Disabled
      var xAxisLabels8 = {categories: ['0.0% to 4.4%','4.5% to 10.0%', '10.1% to 15.5%', '15.6% to 21.1%', '21.2% to 100.0%']};
      //Low Income
      var xAxisLabels9 = {categories: ['0.0% to 0.0%','0.1% to 17.4%', '17.5% to 37.5%', '37.6% to 57.6%', '57.7% to 100.0%']};
      ...
      $('#layer-change li:eq(1)').click(function(){
         chart.series[0].setData([{y:89,color:'#ffffcc'},   {y:257,color:'#a1dab4'},   {y:658,color:'#41b6c4'},   {y:280,color:'#2c7fb8'},   {y:84,color:'#253494'}] );
      ...
      $('#layer-change li:eq(2)').click(function() {
          chart.series[0].setData([{y:31,color:'#ffffcc'},   {y:389,color:'#a1dab4'},   {y:631,color:'#41b6c4'},   {y:234,color:'#2c7fb8'},   {y:83,color:'#253494'}] );
          chart.yAxis[0].setExtremes(0,900);
          chart.update({
             tooltip: {
                  enabled: true,
      ...
      $('#layer-change li:eq(3)').click(function() {
          chart.series[0].setData([{y:39,color:'#ffffcc'},   {y:264,color:'#a1dab4'},   {y:737,color:'#41b6c4'},   {y:272,color:'#2c7fb8'},  {y:56,color:'#253494'}] );
          chart.yAxis[0].setExtremes(0,900);
          chart.update({
             tooltip: {
                  enabled: true,
       ...
       $('#layer-change li:eq(4)').click(function() {
          chart.series[0].setData([{y:2,color:'#ffffcc'},    {y:610,color:'#a1dab4'},   {y:401,color:'#41b6c4'},   {y:162,color:'#2c7fb8'},  {y:193,color:'#253494'}] );
          chart.yAxis[0].setExtremes(0,900);
          chart.update({
             tooltip: {
                  enabled: true,
      ...
      $('#layer-change li:eq(5)').click(function() {
          chart.series[0].setData([{y:18,color:'#ffffcc'},   {y:366,color:'#a1dab4'},   {y:794,color:'#41b6c4'},   {y:90,color:'#2c7fb8'},   {y:100,color:'#253494'}] );
          chart.yAxis[0].setExtremes(0,900);
          chart.update({
             tooltip: {
                  enabled: true,
      ...
      $('#layer-change li:eq(6)').click(function() {
          chart.series[0].setData([{y:1,color:'#ffffcc'},    {y:496,color:'#a1dab4'},   {y:584,color:'#41b6c4'},   {y:168,color:'#2c7fb8'},  {y:119,color:'#253494'}] );
          chart.yAxis[0].setExtremes(0,900);
          chart.update({
             tooltip: {
                  enabled: true,
      ...
      $('#layer-change li:eq(7)').click(function() {
          chart.series[0].setData([{y:34,color:'#ffffcc'},   {y:443,color:'#a1dab4'},  {y:658,color:'#41b6c4'},  {y:113,color:'#2c7fb8'},  {y:120,color:'#253594'}] );
          chart.yAxis[0].setExtremes(0,900);
          chart.update({
             tooltip: {
                  enabled: true,
      ...
      $('#layer-change li:eq(8)').click(function() {
          chart.series[0].setData([{y:27,color:'#ffffcc'},   {y:452,color:'#a1dab4'},  {y:518,color:'#41b6c4'},  {y:268,color:'#2c7fb8'},  {y:103,color:'#253594'}] );
          chart.yAxis[0].setExtremes(0,900);
          chart.update({
             tooltip: {
                  enabled: true,
      ...
      $('#layer-change li:eq(9)').click(function() {
          chart.series[0].setData([{y:2,color:'#ffffcc'},{y:564,color:'#a1dab4'},  {y:443,color:'#41b6c4'},  {y:191,color:'#2c7fb8'},  {y:168,color:'#253594'}] );
          chart.yAxis[0].setExtremes(0,900);
          chart.update({
             tooltip: {
                  enabled: true,
